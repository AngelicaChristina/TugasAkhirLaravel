...
use App\Repositories\PageBlogRepositories;
...
class PageBlogController extends Controller
{
    ...
    public function __construct(PageBlogRepositories $pageBlog){
        ...
        $this->pageBlogRepositories = $pageBlog;
    }
    public function index()
    {
        $data = $this->pageBlogRepositories->get();
        return view("PageBlog/index", compact("data"));
    }
